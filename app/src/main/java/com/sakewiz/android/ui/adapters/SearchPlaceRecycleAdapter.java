...
public class SearchPlaceRecycleAdapter extends RecyclerView.Adapter<SearchPlaceRecycleAdapter.SearchPlaceRowHolder>  {
    ...
    public SearchPlaceRecycleAdapter(Activity context, List<Place> searchResultList) {
        this.mSearchResultList = searchResultList;
        this.mContext = context;
    }

    @Override
    public SearchPlaceRecycleAdapter.SearchPlaceRowHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.search_result_brewery_item, null);
        SearchPlaceRecycleAdapter.SearchPlaceRowHolder mh = new SearchPlaceRecycleAdapter.SearchPlaceRowHolder(v);
...
//            }
            ...
            if(SearchPlacesFragment.searchPlacesFragment != null){
                if((item.getLat() != null && !item.getLat().isEmpty())
                    ...
                    SearchPlacesFragment.searchPlacesFragment.createMarker(item.getLat(), item.getLon());
                }
            }
...
//                        MainFragment.mainFragment.performProductFacadeRequest(item.getId());
                    ((MainActivity)mContext).addFragment(new BarDetailsFragment().newInstance(), ProductDetailsFragment.getTAG(), 2);
                }
            });
        }
    ...
    @Override
    public void onViewDetachedFromWindow(SearchPlaceRecycleAdapter.SearchPlaceRowHolder holder) {
        super.onViewDetachedFromWindow(holder);
        ((SearchPlaceRecycleAdapter.SearchPlaceRowHolder) holder).clearAnimation();
    }
    ...
    public class SearchPlaceRowHolder extends RecyclerView.ViewHolder {
        ...
        @Bind(R.id.parent_container_brewery_search) CardView parentContainer;
