...
/**
 * Created by dilshan_e on 7/08/2017.
 */
public class BreweryDetailsFragment extends BaseFragment implements ProductView{

    final String TAG = BreweryDetailsFragment.this.getClass().getSimpleName();

    public static BreweryDetailsFragment mainFragment = null;
...
//    }
    ...
    public static BreweryDetailsFragment newInstance() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_brewery_details, container, false);
...
//        tabLayout.setupWithViewPager(mViewPager, true);
    ...
    public void initializePresenter() {
        ...
        presenter.attachView(BreweryDetailsFragment.this);
        presenter.onCreate();
    }
...
//                mItem = null;
    ...
    protected void setUpToolBar() {
        ...
        mTitle.setText(R.string.brewery_details);
